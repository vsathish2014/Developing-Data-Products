...
shinyUI(
  pageWithSidebar(
    ...
    mainPanel(
      p('The Body mass index (BMI) is a measure of body fat using  height and weight.'),
      p(' The World Health Organization (WHO) proposes the following classification based on BMI:'),
      tags$div(
        tags$ul(
      ...
      p('You are classified as:'),strong(verbatimTextOutput("bmi"))
